...
export default function RegistrationPage() {
    ...
    const validate = () => {
        ...
        setFullNameError(
            FormValidation.validateFullName(fullName)
            ? ''
            : 'Please enter a valid full name'
        );
        setRoleError(
            FormValidation.validateRole(checkedRoles)
            ? ''
        ...
        <Layout>
            <form className="mx-auto">
                ...
                <div className="flex items-center mb-4 space-x-3">
                    ...
                    {roleError && <p className="mt-2 text-sm text-red-600 dark:text-red-500">{roleError}</p>}
                </div>
