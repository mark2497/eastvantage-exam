        ...
        <Layout>
            <form className="mx-auto">
                <div className="mb-5">
                    ...
                    {fullNameError && <p class="mt-2 text-sm text-green-600 dark:text-green-500">{fullNameError}</p>}
                </div>
                <div className="mb-5">
                    ...
                    {emailError && <p class="mt-2 text-sm text-green-600 dark:text-green-500">{emailError}</p>}
                </div>
