    ...
    return (
        <Layout>
            <form className="mx-auto">
                ...
                {roles.map((item) => (
                    <label key={`label_role_${item}`} className="flex items-center space-x-1 p-4 border border-gray-300 rounded-md shadow-sm hover:shadow-md transition duration-300 ease-in-out cursor-pointer">
                    <input
                        key={`role_${item}`}
                        type="checkbox"
